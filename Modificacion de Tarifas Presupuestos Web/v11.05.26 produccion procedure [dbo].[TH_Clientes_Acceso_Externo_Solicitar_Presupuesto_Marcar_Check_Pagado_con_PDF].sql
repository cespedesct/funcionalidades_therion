...
begin try
      ...
      where l.codigo=@cod_TH_Presupuestos_Web
       ...
       if @extension='pdf'
          begin
             set @obj_fichero='<embed style="display:inline-block;width:auto;height:100%" src="'+@url_fichero+'" type="application/'+@extension+'"/>'
          end
       else
         begin
            set @obj_fichero='<img style="display:inline-block;width:100%;height:auto;object-fit:contain" src="'+@url_fichero+'" />'
         end
