...
begin try
      ...
      +'<div id="panelacciones" style="border:solid 0px #a00;height:100%;width:100%;overflow-y:auto;margin:auto;text-align:left;vertical-align:top">'
          ...
          +'<div style="vertical-align:top;display:inline-block;width:35%;height:54vh;border:solid 0px red;padding-left:1vw;">'
                ...
                +'<div style="margin-left:14.2vw;display:block;width:12vw;text-align:right;font-size:0.65vw;color:#a00;margin-top:0.8vh;margin-bottom:0.8vh;"><b>Nota: Si el justificante incluye un concepto, es obligatorio escribir aquí el mismo concepto.</b></div>'
                +'<span style="display:inline-block;width:15vw;padding-right:1vw;font-size:1vw;text-align:right;">Fecha Transferencia:</span>'
